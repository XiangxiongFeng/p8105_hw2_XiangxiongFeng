...
MCI. The average current age is `r mean(baseline_df$current_age)`, average age at onset is `r mean(baseline_df$age_at_onset)`. `r (length(which(sex_apoe$apoe4 == 'carrier')))/46` of women in the study are APOE4 carriers.
